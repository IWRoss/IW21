<div class="sharing-links">
    <ul class="share-menu">
        <li class="share-link"><strong>Share:</strong></li>
        <li class="share-link">
        ...
        <li class="share-link">
            <a href="<?php echo 'https://plus.google.com/share?url=' . urlencode( get_permalink() ); ?>" target="_blank" id="google" class="track-share-link">
                <img src="<?php echo get_template_directory_uri(); ?>/imgs/social-icons/google.svg" alt="Google Plus" class="social-icon">
            </a>
        </li>
    </ul>
</div>
