 ...
 * Add ACF Blocks
 */
function iw17_add_custom_blocks()
{
...
add_action('acf/init', 'iw17_add_custom_blocks');


function iw17_add_body_classes_for_blocks_in_content($classes) {
...
add_filter('body_class', 'iw17_add_body_classes_for_blocks_in_content');