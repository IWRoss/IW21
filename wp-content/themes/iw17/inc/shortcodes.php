 ...
 */
function iw17_signoff_shortcode() {
	return '<img src="' . get_template_directory_uri() . '/imgs/logo-mark.svg" alt="iw" class="signoff" />';
}
add_shortcode( 'signoff', 'iw17_signoff_shortcode' );

// init process for registering our button
function iw17_shortcode_button_init() {
	...
	add_filter("mce_external_plugins", "iw17_register_tinymce_plugin");

	// Add a callback to add our button to the TinyMCE toolbar
	add_filter('mce_buttons', 'iw17_add_tinymce_button');
}
add_action('init', 'iw17_shortcode_button_init');

//T his callback registers our plug-in
function iw17_register_tinymce_plugin($plugin_array) {
    $plugin_array['iw17_button'] = get_template_directory_uri() . '/js/shortcodes.js';
    return $plugin_array;
}

// This callback adds our button to the toolbar
function iw17_add_tinymce_button($buttons) {
 ...
 * Mailchimp shortcode
 */
function iw17_signup_shortcode( $atts ) {
	...
	<div class="call-to-action call-to-action-narrow">
	    <div class="call-to-action--single">
			...
			<?php iw17_mailchimp_html_form( $a['id'] ); ?>
		</div>
	</div>
...
add_shortcode( 'signup', 'iw17_signup_shortcode' );

/**
 * Logos shortcode
 */
function iw17_logo_slider( $atts ) {
...
add_shortcode( 'clients', 'iw17_logo_slider' );

/**
 * Display Industries list
 */
function iw17_industries_list_shortcode() {
...
add_shortcode( 'industries', 'iw17_industries_list_shortcode' );
