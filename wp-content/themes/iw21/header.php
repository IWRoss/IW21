...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		if (is_front_page()) :
			iw21_parallax_background('graph');
		else :
			iw21_parallax_background('graph', false);
		endif;
		...
		<header id="masthead" class="site-hero">
			...
			<div class="site-header">
				...
				<nav id="site-navigation" class="main-navigation">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e('Menu', 'iw21'); ?></button>
					<?php
					wp_nav_menu(array(
