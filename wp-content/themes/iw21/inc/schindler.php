 ...
 */
function iw21_schindler_stylesheet() {

    if ( is_page( 'schindler' )  ) {
        wp_enqueue_style( 'iw21-schindler', get_template_directory_uri() . '/schindler.css', false );

        wp_enqueue_script( 'iw21-slick-script', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', array( 'jquery' ) );
    }

}
add_action( 'wp_enqueue_scripts', 'iw21_schindler_stylesheet' );

/**
 * Add Schindler features
 */
function iw21_add_schindler_features() {
...
add_action( 'after_setup_theme', 'iw21_add_schindler_features' );

/**
 * Add ACF Blocks
 */
function iw21_add_schindler_blocks() {
...
add_action( 'acf/init', 'iw21_add_schindler_blocks' );


function iw21_add_label_to_schindler_flexible_content_field( $title, $field, $layout, $i ) {
...
// name
add_filter('acf/fields/flexible_content/layout_title/name=business_areas', 'iw21_add_label_to_schindler_flexible_content_field', 10, 4);
add_filter('acf/fields/flexible_content/layout_title/name=team', 'iw21_add_label_to_schindler_flexible_content_field', 10, 4);
