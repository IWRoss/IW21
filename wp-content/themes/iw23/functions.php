...
function iw23_scripts()
{
	...
	wp_localize_script('iw21-scripts', 'iw', array(
		'ajaxUrl' => admin_url('admin-ajax.php'),
		'nonce' => wp_create_nonce('iw21-nonce'),
		'rssUrl' => 'https://www.youtube.com/feeds/videos.xml?playlist_id=PLRt2FOzzk9oe0JsqT7gDrYaA9PiHSo8k-'
	));
