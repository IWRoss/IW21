...
function iw21_add_custom_blocks()
{
    ...
    if (function_exists('acf_register_block_type')) {
        ...
        // Register block for the podcast RSS feed
        acf_register_block_type(array(
            'name'              => 'podcast',
            'title'             => __('Podcast'),
            'description'       => __('Descriptive Text'),
            'render_template'   => 'template-parts/blocks/block-podcast.php',
            'category'          => 'iw-blocks',
            'enqueue_style'     => get_template_directory_uri() . '/template-parts/blocks/assets/block-podcast.css',
            'icon'              => array(
                'background' => '#ff8d00',
                'foreground' => '#ffffff',
                'src'        => 'microphone',
